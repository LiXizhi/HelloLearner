...
- Exactly three records: `.hellolearner/profile.json`, `.hellolearner/progress.json`, `.hellolearner/settings.json`.
...
- It rewrites the local `../AIChat/AIChat.html` engine URL in `js/aichat-bridge.js` to the release URL.
