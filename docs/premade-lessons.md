...
generate a JSON artifact second, then preview and revise it. HelloLearner does
not yet generate, publish, or remotely manage packs. No new host command or
learner storage record is introduced.
