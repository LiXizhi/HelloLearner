export function examplePlan(id = 'plan-test') {
  return { schemaVersion: 1, id, title: '旅行英语 · 每日练习', goal: '能在旅途中自然表达需求', level: 'A1', dailyMinutes: 10,
    lessons: Array.from({ length: 14 }, (_, i) => ({ id: `day-${String(i + 1).padStart(2, '0')}`, title: `旅行交流 ${i + 1}`,
